...
import copy
from reservoir_acme import actors
from reservoir_acme.agents.tf.reservoir import learning
...
class ReservoirDQN(agent.Agent):
    """DQN agent.
    ...
    def __init__(
        ...
        actor = actors.ReservoirActor(policy_network=network, adder=adder)
        self.network = network
        # The learner updates the parameters (and initializes them).
        learner = learning.ReservoirDQNLearner(
            network=network,
